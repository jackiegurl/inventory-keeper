...
/***/ function(module, exports, __webpack_require__) {
	...
	var Userpage = __webpack_require__(161);
	...
	var Main = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      this.state.hasToken ? React.createElement(Userpage, { data: this.state.username, tokenRemoval: this.toggleLog }) : React.createElement(Homepage, { tokenCreated: this.toggleLog })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Homepage = React.createClass({
	  ...
	  letsGetToken: function letsGetToken() {
	  ...
	  getNameCreateToken: function getNameCreateToken(input) {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { onSubmit: this.props.tokenCreated },
	      React.createElement(
	        'div',
	        { className: 'homepage-background-content' },
	        React.createElement(
	          'div',
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'div',
	              { className: 'tradesy-logo' },
	              'Tradesy'
	            ),
	            React.createElement(
	              'span',
	              { className: 'homepage-header-right-links' },
	              React.createElement(
	                'a',
	                { id: 'homepage-links-signup', className: 'homepage-links', onClick: this.letsGetToken },
	                'Sign Up'
	              )
	            )
	          )
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'homepage-main-content-text' },
	            React.createElement(
	              'div',
	              { className: 'closet-cash' },
	              'Turn Your Closet Into Cash'
	            ),
	            React.createElement(
	              'div',
	              { className: 'closet-headline' },
	              'Selling is Safe and Simple'
	            ),
	            React.createElement(
	              'button',
	              { className: 'start-selling', onClick: this.letsGetToken },
	              'Start Selling'
	            ),
	            this.state.popUp ? React.createElement(Modal, { className: 'homepage-links', getUserName: this.getNameCreateToken }) : null
	          )
	        )
	      )
	    );
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'text', ref: 'inputName', className: 'input-text-username',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Closet = __webpack_require__(163);
	var AddItem = __webpack_require__(167);
	var DummyData = __webpack_require__(170);
	...
	var Userpage = React.createClass({
	  ...
	  handleClosetOnClick: function handleClosetOnClick() {
	    this.setState({ pageKey: "closet" });
	  },

	  //tells it to render the addItem view
	  handleAddItemOnClick: function handleAddItemOnClick() {
	  ...
	  handleSubmission: function handleSubmission(input) {
	  ...
	  render: function render() {
	    ...
	    switch (this.state.pageKey) {
	      case "closet":
	        pageRender = React.createElement(Closet, { data: this.state.items });
	        break;
	      case "addItem":
	        pageRender = React.createElement(AddItem, { getSubmission: this.handleSubmission });
	        break;
	    }

	    return React.createElement(
	      "div",
	      { onFocus: this.loadCloset },
	      React.createElement(
	        "div",
	        { className: "userpage-topbar" },
	        React.createElement(
	          "div",
	          { className: "homepage-header-content" },
	          React.createElement(Header, { goCloset: this.handleClosetOnClick, goAddItem: this.handleAddItemOnClick, tokenRemoval: this.removeToken })
	        )
	      ),
	      React.createElement(
	        "div",
	        { className: "userpage-main-content" },
	        pageRender
	      )
	    );
	  }
	...
	var Userpage = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'tradesy-logo-user' },
	        'Tradesy'
	      ),
	      React.createElement(
	        'span',
	        { className: 'homepage-header-right-links-user' },
	        React.createElement(
	          'a',
	          { onClick: this.props.goCloset, className: 'homepage-links' },
	          'My Closet'
	        ),
	        React.createElement(
	          'a',
	          { onClick: this.props.goAddItem, className: 'homepage-links' },
	          'Add Item'
	        ),
	        React.createElement(
	          'a',
	          { onClick: this.props.tokenRemoval, className: 'homepage-links' },
	          'Log Out'
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var ClosetTable = __webpack_require__(164);
	var ClosetImage = __webpack_require__(166);
	var ClosetHeader = React.createClass({
	  displayName: 'ClosetHeader',
	  ...
	  changeToTable: function changeToTable() {
	    this.setState({ viewStyle: "table" });
	  },

	  //changes view to image view
	  changeToImage: function changeToImage() {
	  ...
	  render: function render() {
	    ...
	    if (this.state.items) {
	      switch (this.state.viewStyle) {
	        case "table":
	          pageView = React.createElement(ClosetTable, { data: this.state.items });
	          break;
	        case "image":
	          pageView = this.state.items.map(function (item, i) {
	            return React.createElement(ClosetImage, { data: item, key: i });
	          });
	          break;
	      }
	    }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'closet-header-container' },
	        React.createElement(
	          'div',
	          null,
	          React.createElement(
	            'a',
	            { className: 'closet-header-links', onClick: this.changeToTable },
	            'Table View'
	          ),
	          React.createElement(
	            'a',
	            { className: 'closet-header-links', onClick: this.changeToImage },
	            'Image View'
	          )
	        )
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var TableItem = __webpack_require__(165);

	var ClosetTable = React.createClass({
	  displayName: 'ClosetTable',
	  ...
	  render: function render() {
	    var tableItemStructure = this.props.data.map(function (item, i) {
	      return React.createElement(TableItem, { data: item, key: i });
	    });
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'tr',
	          { className: 'tableItem-column-names' },
	          React.createElement(
	            'th',
	            null,
	            'Edit'
	...
	var TableItem = React.createClass({
	  ...
	  makeChanges: function makeChanges() {
	    ...
	    for (var i = 0; i < checkStorage.length; i++) {
	      if (this.state.data.brand == checkStorage[i].brand && this.state.data.color == checkStorage[i].color && this.state.data.condition == checkStorage[i].condition && this.state.data.headline == checkStorage[i].headline && this.state.data.image == checkStorage[i].image && this.state.data.price == checkStorage[i].price && this.state.data.type == checkStorage[i].type) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'tbody',
	      null,
	      this.state.showItem ? React.createElement(
	        'tr',
	        null,
	        React.createElement(
	          'td',
	          null,
	          React.createElement('i', { className: 'table-i fa fa-times', onClick: this.removeItem }),
	          React.createElement('i', { className: 'table-i fa fa-cog', onClick: this.editItem }),
	          this.state.showEdit ? React.createElement('div', null) : React.createElement(
	            'button',
	            { onClick: this.makeChanges, id: 'submit-changes-t',
	              className: 'closet-image-text' },
	            'Submit'
	          )
	        ),
	        React.createElement(
	        ...
	        React.createElement(
	          ...
	          this.state.showEdit ? React.createElement('i', { className: 'fa fa-picture-o' }) : React.createElement('input', { type: 'text', className: 'edit-item-t', ref: 'itemImage',
	            placeholder: this.state.data.image }),
	          React.createElement(
	            'span',
	            { className: 'show-item-picture' },
	            React.createElement('img', { src: tableItemImage, className: 'show-item-picture-properties' })
	          )
	        ),
	        React.createElement(
	          'td',
	          null,
	          ' ',
	          this.state.showEdit ? this.state.data.type : React.createElement('input', { type: 'text', className: 'edit-item-t', ref: 'itemType',
	        ...
	        React.createElement(
	          ...
	          null,
	          ' ',
	          this.state.showEdit ? this.state.data.brand : React.createElement('input', { type: 'text', className: 'edit-item-t', ref: 'itemBrand',
	        ...
	        React.createElement(
	          ...
	          null,
	          ' ',
	          this.state.showEdit ? this.state.data.headline : React.createElement('input', { type: 'text', className: 'edit-item-t', ref: 'itemHeadline',
	            placeholder: this.state.data.headline }),
	          ' '
	        ),
	        React.createElement(
	          'td',
	          null,
	          ' ',
	          this.state.showEdit ? this.state.data.color : React.createElement('input', { type: 'text', className: 'edit-item-t', ref: 'itemColor',
	        ...
	        React.createElement(
	          ...
	          null,
	          ' ',
	          this.state.showEdit ? this.state.data.condition : React.createElement('input', { type: 'text', className: 'edit-item-t', ref: 'itemCondition',
	            placeholder: this.state.data.condition }),
	          ' '
	        ),
	        React.createElement(
	          'td',
	          null,
	          ' ',
	          this.state.showEdit ? this.state.data.price : React.createElement('input', { type: 'text', className: 'edit-item-t', ref: 'itemPrice',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClosetImage = React.createClass({
	  ...
	  //and see which index it should store the new changes
	  //it then re-sets the data state so that it could immediately propagate
	  makeChanges: function makeChanges(event) {
	    event.preventDefault();
	    this.setState({ showChange: !this.state.showChange });
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      this.state.showItem ? React.createElement(
	        'div',
	        { className: 'closet-image-view-container' },
	        React.createElement(
	          'div',
	          { className: 'closet-image-view-boxsize', style: backgroundImage },
	          React.createElement(
	            'div',
	            { className: 'closet-image-view-info' },
	            React.createElement(
	              'div',
	              { id: 'icon-topright', className: 'closet-image-text', onClick: this.removeInput },
	              React.createElement('i', { className: 'fa fa-times' })
	            ),
	            React.createElement(
	              'div',
	              { id: 'icon-topright', className: 'closet-image-text', onClick: this.editInput },
	              React.createElement('i', { className: 'fa fa-cog' })
	            ),
	            React.createElement(
	              'span',
	              { className: 'closet-image-view-info-text' },
	              React.createElement(
	                'div',
	                { className: 'closet-image-container' },
	                React.createElement(
	                  'form',
	                  { onSubmit: this.makeChanges },
	                  React.createElement(
	                    'div',
	                    { className: 'closet-image-text' },
	                    this.state.showChange ? React.createElement('div', null) : React.createElement('input', { type: 'text', className: 'edit-item', ref: 'itemImage', placeholder: this.state.data.image })
	                  ),
	                  React.createElement(
	                    'div',
	                    { className: 'closet-image-text' },
	                    this.state.showChange ? this.state.data.brand : React.createElement('input', { type: 'text', className: 'edit-item', ref: 'itemBrand', placeholder: this.state.data.brand })
	                  ),
	                  React.createElement(
	                    'div',
	                    { className: 'closet-image-text' },
	                    this.state.showChange ? this.state.data.headline : React.createElement('input', { type: 'text', className: 'edit-item', ref: 'itemHeadline', placeholder: this.state.data.headline })
	                  ),
	                  React.createElement(
	                    'div',
	                    { className: 'closet-image-text' },
	                    this.state.showChange ? this.state.data.color : React.createElement('input', { type: 'text', className: 'edit-item', ref: 'itemColor', placeholder: this.state.data.color })
	                  ),
	                  React.createElement(
	                    'div',
	                    { className: 'closet-image-text' },
	                    this.state.showChange ? this.state.data.condition : React.createElement('input', { type: 'text', className: 'edit-item', ref: 'itemCondition', placeholder: this.state.data.condition })
	                  ),
	                  React.createElement(
	                    'div',
	                    { className: 'closet-image-text' },
	                    this.state.showChange ? this.state.data.type : React.createElement('input', { type: 'text', className: 'edit-item', ref: 'itemType', placeholder: this.state.data.type })
	                  ),
	                  React.createElement(
	                    'div',
	                    { className: 'closet-image-text' },
	                    this.state.showChange ? this.state.data.price : React.createElement('input', { type: 'text', className: 'edit-item', ref: 'itemPrice', placeholder: this.state.data.price })
	                  ),
	                  this.state.showChange ? React.createElement('div', null) : React.createElement(
	                    'button',
	                    { onClick: this.makeChanges, id: 'submit-changes', className: 'closet-image-text' },
	                    'Submit'
	                  )
	                )
	              )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var TypeItem = __webpack_require__(168);
	var TypeCondition = __webpack_require__(169);
	var DummyData = __webpack_require__(170);
	...
	var AddItem = React.createClass({
	  ...
	  submitItemInfo: function submitItemInfo(event) {
	    event.preventDefault();
	  ...
	  itemConditionSelection: function itemConditionSelection(conditionInput) {
	    this.setState({ condition: conditionInput });
	  },

	  itemTypeSelection: function itemTypeSelection(typeInput) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'form',
	        { onSubmit: this.props.getSubmission },
	        React.createElement(
	          'div',
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'div',
	              { className: 'inventory-col-padding row' },
	              React.createElement(
	                'div',
	                { className: 'col-md-4' },
	                React.createElement(
	                  'div',
	                  { className: 'inventory-leftcol-text' },
	                  'Type Of Item'
	                )
	              ),
	              React.createElement(
	                ...
	                React.createElement(
	                  'div',
	                  { className: 'inventory-rightcol-text' },
	                  React.createElement(TypeItem, { itemTypeSelection: this.itemTypeSelection })
	                )
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    'div',
	                    { className: 'inventory-type-small-description' },
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement('input', { type: 'text',
	                    className: 'inventory-textarea-input', ref: 'itemImage', required: true })
	                )
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  'div',
	                  { className: 'inventory-rightcol-text' },
	                  React.createElement('input', { type: 'text', className: 'inventory-text-price',
	                    id: 'inv-brand', onChange: this.checkInput, ref: 'itemBrand', required: true })
	                )
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    'div',
	                    { className: 'inventory-type-small-description' },
	                    'i.e Leather Jacket with Vintage Patches, Belt with a Britney Spears signature'
	                  )
	                )
	              ),
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement('textarea', { type: 'text',
	                    ...
	                    id: 'inv-headline', onChange: this.checkInput, required: true })
	                )
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  'div',
	                  { className: 'inventory-rightcol-text' },
	                  React.createElement('input', { type: 'text', id: 'inv-color', className: 'inventory-text-price', ref: 'itemColor', onChange: this.checkInput, required: true })
	                )
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  'div',
	                  { className: 'inventory-rightcol-text' },
	                  React.createElement(TypeCondition, { itemConditionSelection: this.itemConditionSelection })
	                )
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  'div',
	                  { className: 'inventory-rightcol-text' },
	                  React.createElement('input', { type: 'number', id: 'inv-number', min: '0.01', max: '9999', step: '0.01', className: 'inventory-text-price', ref: 'itemPrice', onChange: this.checkInput, required: true })
	                )
	              )
	            ),
	            React.createElement(
	              'button',
	              { id: 'submit-to-check', className: 'inventory-submit',
	                onClick: this.submitItemInfo },
	              'Submit'
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TypeItem = React.createClass({
	  ...
	  setClothes: function setClothes() {
	  ...
	  setAccessories: function setAccessories() {
	  ...
	  sendToParent: function sendToParent(input) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { onChange: this.props.itemTypeSelection },
	      React.createElement(
	        'table',
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'td',
	              { className: 'inventory-table-td' },
	              React.createElement(
	                'div',
	                { id: 'type-clothes', onClick: this.setClothes },
	                React.createElement(
	                  'div',
	                  { id: 'type-clothes-text', className: 'inventory-type-title' },
	                  React.createElement(
	                    'a',
	                    null,
	                    'Clothes'
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'div',
	                { id: 'type-accessories', className: 'inventory-type', onClick: this.setAccessories },
	                React.createElement(
	                  'div',
	                  { id: 'type-accessories-text', className: 'inventory-type-title' },
	                  React.createElement(
	                    'a',
	                    null,
	                    'Accessories'
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'div',
	                { id: 'type-shoes', className: 'inventory-type-lastbox', onClick: this.setShoes },
	                React.createElement(
	                  'div',
	                  { id: 'type-shoes-text', className: 'inventory-type-title' },
	                  React.createElement(
	                    'a',
	                    null,
	                    'Shoes'
	      ...
	      React.createElement(
	        'div',
	        { className: 'inventory-typeItem-small-description' },
	        typeDescription
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TypeCondition = React.createClass({
	  ...
	  setLikeNew: function setLikeNew() {
	  ...
	  setGentlyWorn: function setGentlyWorn() {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { onChange: this.props.itemConditionSelection },
	      React.createElement(
	        'table',
	        { className: 'inventory-table' },
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'div',
	                { id: 'type-new', onClick: this.setNew },
	                React.createElement(
	                  'div',
	                  { id: 'type-new-text', className: 'inventory-type-title' },
	                  React.createElement(
	                    'a',
	                    null,
	                    'New'
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'div',
	                { id: 'type-likeNew', className: 'inventory-type', onClick: this.setLikeNew },
	                React.createElement(
	                  'div',
	                  { id: 'type-likeNew-text', className: 'inventory-type-title' },
	                  React.createElement(
	                    'a',
	                    null,
	                    'Like New'
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'div',
	                { id: 'type-gentlyWorn', className: 'inventory-type-lastbox', onClick: this.setGentlyWorn },
	                React.createElement(
	                  'div',
	                  { id: 'type-gentlyWorn-text', className: 'inventory-type-title' },
	                  React.createElement(
	                    'a',
	                    null,
	                    'Gently Worn'
